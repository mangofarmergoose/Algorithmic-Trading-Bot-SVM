...
client = Client(config.api_key_test, config.api_secret_test, testnet=config.isTestnet)
client_query = Client(config.api_key_test, config.api_secret_test)
...
class HistoricalData:
    ...
    def SetKLineData(self):
        test = client_query.get_historical_klines(symbol=self.symbol, interval=self.interval ,start_str="15 Jun, 2022")
